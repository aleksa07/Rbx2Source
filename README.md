...
- If you're having issues, try running the [Cache Clearer](https://github.com/aleksa07/Rbx2Source/raw/main/Clear%20Cache.bat).  If that doesn't fix anything, create a github issue.
